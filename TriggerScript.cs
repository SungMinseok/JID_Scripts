...
public class TriggerScript : MonoBehaviour
{
    ...
    Coroutine prologueActionCoroutine;

    public Location prologueLocation;
        ...
        if (DBManager.instance.CheckTrigOver(location.trigNum))
        {
            switch (location.trigNum)
            {
                ...
                case 17:
                    ...
                    if (!DBManager.instance.CheckTrigOver(51))
                    {//광장 노개미 완료 안했으면
    ...
    public void Action(Location location, bool waitInTrigger = false)
    {
        ...
        if (location != null){
            if(location.trigNum == 107){
                
                prologueActionCoroutine = StartCoroutine(ActionCoroutine(location));
            }
            else{
    ...
    IEnumerator ActionCoroutine(Location location)
    {
        ...
        if (location.type == LocationType.Trigger)
        {
            ...
            switch (location.trigNum)
            {
                ...
                case 22:
                    ...
                    if (InventoryManager.instance.CheckHaveItem(10))
                    {
                        ...
                        if (GetSelect() == 0)
                        {
                            ...
                            SubGameScript.instance.CreateDrops();
                    ...
                    else
                    {
                        ...
                        if (GetSelect() == 0)
                        {
                            ...
                            )
                            {
                                ...
                                // SetSelect(selects[1]);
                                // yield return waitSelecting;
                                if (GetSelect() == tempSelect26.answers.Length - 1)
                                {//주지 않는다.
                ...
                case 31:
                    ...
                    if (GetSelect() == 0)
                    {
                        ...
                        if (DBManager.instance.curData.roulettePlayCount >= 20 && !InventoryManager.instance.CheckHaveItem(56))
                        {

                            SetDialogue(dialogues[4]);
                            yield return waitTalking;

                            InventoryManager.instance.AddItem(56, activateDialogue: true, delayTime: 1f);

                            InventoryManager.instance.RemoveItem(2);
                            InventoryManager.instance.UseItemByID(56);
                        }
            ...
            case 45 :
                ...
                case 54:
                    ...
                    objects[2].gameObject.SetActive(false);
                    objects[0].GetComponent<SpriteRenderer>().maskInteraction = SpriteMaskInteraction.None;
                ...
                case 107:
                    ...
                    if (DBManager.instance.debug_passPrologue || DBManager.instance.curData.passPrologue)
                    {
                        ...
                        PlayerManager.instance.Look("right");
                        UIManager.instance.hud_skip_btn.SetActive(false);
                    ...
                    else
                    {
                        ...
                        if(DBManager.instance.localData.canSkipPrologue){
                            UIManager.instance.hud_skip_btn.SetActive(true);
                        }
                        else{
                            UIManager.instance.hud_skip_btn.SetActive(false);
                        ...
                        //테스트용
                        if(!DBManager.instance.debug_passPrologue1){
                            ...
                            yield return new WaitUntil(() => PlayerManager.instance.transform.position.x >= objects[7].position.x);
                            SoundManager.instance.PlaySound("hidden_opendoor");
                            objects[5].gameObject.SetActive(true);
                        ...
                        if(DBManager.instance.debug_passPrologue1){
                            PlayerManager.instance.MovePlayer(objects[1]);
                        }
                        ...
                        SetDialogue(dialogues[1]);
                        yield return waitTalking;
                        UIManager.instance.AcceptQuest(16);
                ...
                #region @108 프롤로그-모자쓰기
                case 108:
                    UIManager.instance.CompleteQuest(16);
                    UIManager.instance.AcceptQuest(15);
                    objects[0].gameObject.SetActive(false);
                    InventoryManager.instance.UseItem(DBManager.instance.cache_ItemDataList[57]);
                    //PlayerManager.instance.Look("right");
                ...
                case 109:
                    ...
                    PlayerManager.instance.Look("right");
                    PlayerManager.instance.animator.SetBool("bed", true);
                    yield return wait2000ms;
                    SetDialogue(dialogues[0]);
                    yield return waitTalking;
                ...
                case 110:
                    ...
                    //스킵시 후처리
                    DBManager.instance.TrigOver(107);
                    PlayerManager.instance.animator.SetBool("bed", false);
                    PlayerManager.instance.animator.SetTrigger("laydown");
                    PlayerManager.instance.wSet = 0;
                    SceneController.instance.SetCameraDefaultZoomIn();
                    SceneController.instance.virtualCamera.GetCinemachineComponent<CinemachineFramingTransposer>().m_XDamping = 0;
                    SceneController.instance.virtualCamera.GetCinemachineComponent<CinemachineFramingTransposer>().m_YDamping = 0;
                    ...
                    SetDialogue(dialogues[2]);
                    yield return waitTalking;
                    SceneController.instance.virtualCamera.Follow = objects[1];
                    yield return wait2000ms;
                    SceneController.instance.virtualCamera.Follow = PlayerManager.instance.transform;
                    yield return wait1000ms;
                    ShakeCamera(1, 1);
        ...
        switch (location.trigNum)
        {
            ...
            // case 108:
            //     UIManager.instance.OpenTutorialUI(8, keyBlock: true);//퀘스트완료
            //     yield return new WaitUntil(() => !UIManager.instance.waitTutorial);
        ...
        switch (location.trigNum)
        {
            ...
            //case 998:
                ...
                {
                    UIManager.instance.CompleteQuest(14);
                    UIManager.instance.OpenTutorialUI(8);
                    yield return new WaitUntil(() => !UIManager.instance.waitTutorial);
                }
                break;
    ...
    public void CameraView(Transform target, float dampingVal = 2)
    {
        if (dampingVal != 2)
        {

            SceneController.instance.virtualCamera.GetCinemachineComponent<CinemachineFramingTransposer>().m_XDamping = dampingVal;
            SceneController.instance.virtualCamera.GetCinemachineComponent<CinemachineFramingTransposer>().m_YDamping = dampingVal;
        }
